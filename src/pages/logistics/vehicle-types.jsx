...
const initialUnitsData = [
    { number: 1, name: "Compact Tractors" },
    { number: 2, name: "SUV" },
    { number: 3, name: "Pickup" },
    { number: 4, name: "Canter" },
    { number: 5, name: "Motorcycle" },
    { number: 6, name: "7 Seater" },
    { number: 7, name: "Van" },
    { number: 8, name: "Pickup" },
    { number: 9, name: "Truck" },
    { number: 10, name: "Salon Car" },
];


export function LogisticsVehicleTypes() {
            ...
            {showForm && (
                <Card className="p-4">
                    <Typography variant="h6" className="mb-4">
                        {editingUnit ? "Edit Unit" : "Add New Vehicle Type"}
                    </Typography>
...
export default LogisticsVehicleTypes;
